...
**Requirements for commentary:** Bible app **v2.6+** (Docker tag `maxivious/bolls:v2.6` or newer) and plugin **v0.3.1+**. Multi-paragraph selections are merged into a single callout.
